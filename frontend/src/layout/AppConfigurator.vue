...
<template>
    <div class="config-panel w-full mb-2 p-2 bg-surface-0 dark:bg-surface-900 border border-surface rounded-border origin-top shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]">
        <div class="flex flex-col gap-4">
            <div>
                <span class="text-sm text-muted-color font-semibold">Couleur primaire</span>
                <div class="pt-2 flex gap-3 flex-wrap justify-between">
                    <button
            ...
            <!-- Surface and Thème side by side -->
            <div class="flex gap-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="pt-2">
                        <Button type="button" severity="secondary" class="layout-topbar-action w-full" @click="toggleDarkMode">
            ...
            <!-- Styles and Style du menu side by side -->
            <div class="flex gap-4">
                <div class="flex-1">
                    <span class="text-sm text-muted-color font-semibold">Styles</span>
                    <div class="pt-2">
                        <SelectButton v-model="preset" @change="onPresetChange" :options="presetOptions" :allowEmpty="false" />
                    </div>
                </div>
                <div class="flex-1">
                    <span class="text-sm text-muted-color font-semibold">Style du menu</span>
                    <div class="pt-2">
