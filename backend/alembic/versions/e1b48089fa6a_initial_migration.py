...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("en_cours", "cloturee", "annulee", name="campagnestatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_campagne_trimestre"), "campagne", ["trimestre"], unique=False
    )
    op.create_table(
        "etudiant",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "campus",
            sa.Enum("gat", "stj", "non_specifie", name="campus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_etudiant_code_permanent"), "etudiant", ["code_permanent"], unique=False
    )
    op.create_table(
        "candidature",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "note",
            sa.Enum("A_p", "A", "A_m", "B_p", "B", "B_m", "non_specifie", name="note"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("confirmee", "non_confirmee", name="coursstatus"),
            nullable=False,
        ),
        sa.Column("cycle", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
            "type", sa.Enum("TD", "TP", "COURS", name="activitetype"), nullable=False
        ),
        sa.Column(
            "mode",
            sa.Enum("PRESENTIEL", "DISTANCIEL", name="activitemode"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("confirmee", "non_confirmee", name="activitestatus"),
            nullable=False,
        ),
