...
class TestCoursDiffer(unittest.TestCase):
    ...
    def test_seance_removed(self):
        ...
        modified_data = deepcopy(self.test_data[1])
        modified_data['LstActCrs'] = modified_data['LstActCrs'][:1]  # Keep only first seance
    ...
    def test_activite_added(self):
        ...
        modified = self.create_modified_course({
            'LstActCrs.0.CollActCrsHor': [*self.test_data[1]['LstActCrs'][0]['CollActCrsHor'], new_activite]
        })
    ...
    def test_activite_removed(self):
        ...
        modified = self.create_modified_course({
            'LstActCrs.0.CollActCrsHor': self.test_data[1]['LstActCrs'][0]['CollActCrsHor'][1:]
        })
